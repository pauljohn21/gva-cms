  ...
  <div>
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate  template-id="cms_Applicant" />
            <ExportExcel  template-id="cms_Applicant" />
            <ImportExcel  template-id="cms_Applicant" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column align="left" label="日期" prop="createdAt" width="180">
          ...
          <!-- <el-table-column align="left" label="cardId字段" prop="cardId" width="120" /> -->
    ...
    <el-drawer destroy-on-close size="800" v-model="dialogFormVisible" :show-close="false" :before-close="closeDialog">
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="cardId字段:"  prop="cardId" >
              <el-input v-model="formData.cardId" :clearable="true"  placeholder="请输入cardId字段" />
            </el-form-item>
    ...
    <el-drawer destroy-on-close size="800" v-model="detailShow" :show-close="true" :before-close="closeDetailShow">
            <el-descriptions :column="1" border>
                    ...
                    <el-descriptions-item label="cardId字段">
                        {{ detailFrom.cardId }}
                    </el-descriptions-item>
