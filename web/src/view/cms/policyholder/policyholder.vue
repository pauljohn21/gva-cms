  ...
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="日期" prop="createdAt" width="180">
          ...
          <el-table-column align="left" label="对公账户" prop="account" width="120" />
          <el-table-column align="left" label="地址" prop="addrs" width="120" />
          ...
          <el-table-column align="left" label="signature字段" prop="signature" width="120" />
        <el-table-column align="left" label="操作" fixed="right" min-width="240">
            ...
            <el-button  type="primary" link icon="edit" class="table-button" @click="updatePolicyholderFunc(scope.row)">变更</el-button>
    ...
    <el-drawer destroy-on-close size="800" v-model="detailShow" :show-close="true" :before-close="closeDetailShow">
            <el-descriptions :column="1" border>
                    ...
                    <el-descriptions-item label="对公账户">
                        {{ detailFrom.account }}
                    </el-descriptions-item>
                    ...
                    <el-descriptions-item label="signature字段">
...
const getTableData = async() => {
  const table = await getPolicyholderList({ page: page.value, pageSize: pageSize.value, ...searchInfo.value })
  if (table.code === 0) {
...
const onDelete = async() => {
  ElMessageBox.confirm('确定要删除吗?', '提示', {
    ...
    type: 'warning'
      ...
      const res = await deletePolicyholderByIds({ IDs })
      if (res.code === 0) {
        ElMessage({
          type: 'success',
          message: '删除成功'
...
// 更新行
const updatePolicyholderFunc = async(row) => {
    const res = await findPolicyholder({ ID: row.ID })
    type.value = 'update'
    if (res.code === 0) {
...
// 删除行
const deletePolicyholderFunc = async (row) => {
    const res = await deletePolicyholder({ ID: row.ID })
    if (res.code === 0) {
        ElMessage({
                type: 'success',
                message: '删除成功'
