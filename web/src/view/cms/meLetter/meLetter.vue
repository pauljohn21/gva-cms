  ...
  <div>
    ...
    <div class="gva-table-box">
        <div class="gva-btn-list">
            ...
            <ExportTemplate  template-id="cms_MeLetter" />
            <ExportExcel  template-id="cms_MeLetter" />
            <ImportExcel  template-id="cms_MeLetter" @on-success="getTableData" />
        </div>
        <el-table
        ref="multipleTable"
        style="width: 100%"
        ...
        <el-table-column align="left" label="出单方式" prop="type" width="120">
            ...
            {{ filterDict(scope.row.type,issuetypeOptions) }}
            </template>
        </el-table-column>
        <el-table-column align="left" label="签署状态" prop="signStatus" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.signStatus,sign_statusOptions) }}
            </template>
        </el-table-column>
       ...
       <template #header>
          ...
          <el-form :model="formData" label-position="top" ref="elFormRef" :rules="rule" label-width="80px">
            <el-form-item label="投保人:"  prop="policyholder" >
              <el-select v-model="formData.policyholder" placeholder="请选择投保人" style="width:100%" :clearable="true" >
            ...
            <el-form-item label="法院:"  prop="court" >
              <el-select v-model="formData.court" placeholder="请选择法院" style="width:100%" :clearable="true" >
    ...
    <el-drawer destroy-on-close size="800" v-model="detailShow" :show-close="true" :before-close="closeDetailShow">
            <el-descriptions :column="1" border>
                    ...
                    <el-descriptions-item label="投保人">
                        {{ detailFrom.policyholder }}
                    </el-descriptions-item>
                    <el-descriptions-item label="申请人">
                        {{ detailFrom.applicant }}
                    </el-descriptions-item>
                    <el-descriptions-item label="被申请人">
                        {{ detailFrom.respondent }}
                    </el-descriptions-item>
                    <el-descriptions-item label="保险信息">
                        {{ detailFrom.info }}
                    </el-descriptions-item>
